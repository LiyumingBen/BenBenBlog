...
<ModuleTransition delay="0.46">
  <div class="footer-wrapper">
    <span class="footer-reco-theme">
      ...
      <a target="blank" href="https://github.com/LiyumingBen">LiyumingBen</a>
    </span>
...
export default({
  ...
  mounted() {
    let dom = document.getElementById('busuanziIdDom')
    // 如果有需要重新删除在添加刷新
    if(!dom) {
      // 添加访问统计
      addScriptToBody('//busuanzi.ibruce.info/busuanzi/2.3/busuanzi.pure.mini.js', 'busuanziIdDom');
    }
  }
})
</script>
